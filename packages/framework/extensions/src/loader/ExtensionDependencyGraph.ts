...
export class ExtensionDependencyGraph {
  private readonly _nodes = new Map<string, ExtensionDescriptor>();

  public addNode(desc: ExtensionDescriptor): void {
  ...
  public getTopologicalOrder(): string[] {
    ...
    const visit = (id: string): void => {
      ...
      if (recStack.has(id)) {
        throw new Error(
          'ExtensionDependencyGraph: Circular dependency detected during topological sort.',
        );
      }
      recStack.add(id);
